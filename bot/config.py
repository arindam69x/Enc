...
class Config:
    def __init__(self):
        try:
            ...
            self.BOT_TOKEN = config("TG_BOT_TOKEN", "6461620240:AAHgH4cDGs_oC6rCUv15EKL0BEZcLbmbtS8")
            ...
            self.DATABASE_URL = config("DATABASE_URL", default=mongodb+srv://Liten:OoIj9FZ6J5ca7K31@cluster0.hcxotkc.mongodb.net/?retryWrites=true&w=majority)
            self.DBNAME = config("DBNAME", default="ENC")
            self.DEV = config("DEV", default=0, cast=int)
            self.DL_STUFF = config("DL_STUFF", default=None)
            self.DUMP_CHANNEL = config("DUMP_CHANNEL", default=-1002007215199, cast=int)
            ...
            self.FCHANNEL = config("FCHANNEL", default=-1002007215199, cast=int)
            ...
            self.LOG_CHANNEL = config("LOG_CHANNEL", default=-1002007215199, cast=int)
